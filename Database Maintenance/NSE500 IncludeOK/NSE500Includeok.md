...
if(Name() == "ALLCARGO.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1201102) OR (Datenum()>=1220331 AND Datenum() < 1221230);}
...
if(Name() == "AMTEKAUTO.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1170929;}
...
if(Name() == "BEML.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1220412) OR (Datenum()>=1221230);}
if(Name() == "BERGEPAINT.EQ-NSE"){includeok = Datenum() >=1090202;}
...
if(Name() == "CHEMPLAST.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1120618) OR (Datenum()>=1220331);}
...
if(Name() == "DRDATSONS.EQ-NSE"){includeok = Datenum() >=1130401 AND Datenum() < 1140328;}
...
if(Name() == "GALAXYSURF.EQ-NSE"){includeok = Datenum() >=1180928;}
...
if(Name() == "GVKPIL.EQ-NSE"){includeok = Datenum() >=1090225 AND Datenum() < 1190329;}
...
if(Name() == "IFBIND.EQ-NSE"){includeok = (Datenum() >=1150327 and Datenum() < 1150928) OR (Datenum()>=1160401 AND Datenum() < 1160930) OR (Datenum()>=1170929);}
...
if(Name() == "IVRCLINFRA.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1160401;}
...
if(Name() == "KITEX.EQ-NSE"){includeok = Datenum() >=1140919 AND Datenum() < 1180928;}
...
if(Name() == "LTI.EQ-NSE"){includeok = Datenum() >=1170331 AND Datenum() < 1221202;}
if(Name() == "LT.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "LAURUSLABS.EQ-NSE"){includeok = Datenum() >=1170526;}
if(Name() == "LEMONTREE.EQ-NSE"){includeok = (Datenum() >=1180928 AND Datenum() < 1220331) OR (Datenum()>=1221230);}
...
if(Name() == "MARKSANS.EQ-NSE"){includeok = Datenum() >=1150327 AND Datenum() < 1180928;}
...
if(Name() == "NESTLEIND.EQ-NSE"){includeok = Datenum() >=1190927;}
...
if(Name() == "NIITLTD.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1160401) OR (Datenum()>=1220930 AND Datenum() < 1221230);}
...
if(Name() == "POLYMED.EQ-NSE"){includeok = Datenum() >=1200626;}
...
if(Name() == "REPCOHOME.EQ-NSE"){includeok = Datenum() >=1140919 AND Datenum() < 1200925;}
...
if(Name() == "SAREGAMA.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1110325) OR (Datenum()>=1221230);}
...
if(Name() == "SCI.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1190927) OR (Datenum()>=1200626 AND Datenum() < 1221230);}
...
if(Name() == "SHREECEM.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "SHPRE.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1090511;}
if(Name() == "RENUKA.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1200925) OR (Datenum()>=1220331);}
if(Name() == "SHRENUJ.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1160401;}
if(Name() == "SHLAKSHMI.EQ-NSE"){includeok = Datenum() >=1120928 AND Datenum() < 1130401;}
if(Name() == "SHRIRAMCIT.EQ-NSE"){includeok = Datenum() >=1120928 AND Datenum() < 1220808;}
if(Name() == "SRTRANSFIN.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1221219;}
if(Name() == "SIEMENS.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "SIMPLEXINF.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1170331;}
if(Name() == "SINTEX.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1170331;}
if(Name() == "SPTL.EQ-NSE"){includeok = Datenum() >=1180402 AND Datenum() < 1190927;}
if(Name() == "SIRPAPER.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1100408;}
if(Name() == "SITINET.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1090327) OR (Datenum()>=1150928 AND Datenum() < 1170331);}
if(Name() == "SJVN.EQ-NSE"){includeok = Datenum() >=1160401;}
if(Name() == "SKFINDIA.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "BHARATFIN.EQ-NSE"){includeok = Datenum() >=1111010 AND Datenum() < 1181228;}
if(Name() == "SMARTLINK.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1100408;}
if(Name() == "SMLISUZU.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1090327) OR (Datenum()>=1160401 AND Datenum() < 1180928);}
if(Name() == "SNOWMAN.EQ-NSE"){includeok = Datenum() >=1160401 AND Datenum() < 1180402;}
if(Name() == "SOBHA.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "SOLARINDS.EQ-NSE"){includeok = Datenum() >=1160401;}
if(Name() == "SOLARA.EQ-NSE"){includeok = Datenum() >=1200925 AND Datenum() < 1220930;}
if(Name() == "SOMANYCERA.EQ-NSE"){includeok = Datenum() >=1160401 AND Datenum() < 1180402;}
if(Name() == "JTEKTINDIA.EQ-NSE"){includeok = (Datenum() >=1090202 and Datenum() < 1130401) OR (Datenum()>=1140328 AND Datenum() < 1160401) OR (Datenum()>=1200914 AND Datenum()< 1210930);}
if(Name() == "SONATSOFTW.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "SOUTHBANK.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1210331;}
if(Name() == "SPANDANA.EQ-NSE"){includeok = (Datenum() >=1191227 AND Datenum() < 1200925) OR (Datenum()>=1210331 AND Datenum() < 1220331);}
if(Name() == "SPICEJET.EQ-NSE"){includeok = Datenum() >=1191227 AND Datenum() < 1220930;}
if(Name() == "SREINFRA.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1190927;}
if(Name() == "SRF.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "SRIPIPES.EQ-NSE"){includeok = Datenum() >=1150928 AND Datenum() < 1160401;}
if(Name() == "STARCEMENT.EQ-NSE"){includeok = Datenum() >=1171120 AND Datenum() < 1220331;}
if(Name() == "SFCL.EQ-NSE"){includeok = Datenum() >=1160930 AND Datenum() < 1170123;}
if(Name() == "SBBJ.EQ-NSE"){includeok = Datenum() >=1111010 AND Datenum() < 1170316;}
if(Name() == "SBIN.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "MYSOREBANK.EQ-NSE"){includeok = Datenum() >=1160930 AND Datenum() < 1170316;}
if(Name() == "SBT.EQ-NSE"){includeok = (Datenum() >=1111010 AND Datenum() < 1160401) OR (Datenum()>=1160930 AND Datenum() < 1170316);}
if(Name() == "STCINDIA.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1120427) OR (Datenum()>=1160401 AND Datenum() < 1170929);}
if(Name() == "SAIL.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "SWSOLAR.EQ-NSE"){includeok = Datenum() >=1200319;}
if(Name() == "STERLINBIO.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1130401;}
if(Name() == "STER.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1120928;}
if(Name() == "STLTECH.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1160118) OR (Datenum()>=1170331);}
if(Name() == "STAR.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1180205) OR (Datenum()>=1180928 AND Datenum() < 1220930);}
if(Name() == "INEOSSTYRO.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1090327) OR (Datenum()>=1160401 AND Datenum() < 1160930);}
if(Name() == "SUDARSCHEM.EQ-NSE"){includeok = Datenum() >=1170331;}
if(Name() == "NTL.EQ-NSE"){includeok = Datenum() >=1111010 AND Datenum() < 1130807;}
if(Name() == "SUMICHEM.EQ-NSE"){includeok = Datenum() >=1200626;}
if(Name() == "SUMMIT.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1090327;}
if(Name() == "SPARC.EQ-NSE"){includeok = (Datenum() >=1130307 AND Datenum() < 1130927) OR (Datenum()>=1140328);}
if(Name() == "SUNPHARMA.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "SUNTV.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "SUNCLAYLTD.EQ-NSE"){includeok = (Datenum() >=1190415 AND Datenum() < 1200626) OR (Datenum()>=1210331 AND Datenum() < 1210930);}
if(Name() == "SUNDARMFIN.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1171113) OR (Datenum()>=1180928);}
if(Name() == "SUNDRMFAST.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "SUNTECK.EQ-NSE"){includeok = Datenum() >=1101125;}
if(Name() == "SUPRAJIT.EQ-NSE"){includeok = (Datenum() >=1160930 and Datenum() < 1170331) OR (Datenum()>=1170929 AND Datenum() < 1180402) OR (Datenum()>=1190329);}
if(Name() == "SUPREMEIND.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "SUPREMEINF.EQ-NSE"){includeok = Datenum() >=1120928 AND Datenum() < 1160401;}
if(Name() == "SUPPETRO.EQ-NSE"){includeok = (Datenum() >=1090202 and Datenum() < 1160401) OR (Datenum()>=1170929 AND Datenum() < 1180402) OR (Datenum()>=1200925 AND Datenum()< 1220407);}
if(Name() == "SURYAROSNI.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1120427;}
if(Name() == "SUVEN.EQ-NSE"){includeok = Datenum() >=1150327 AND Datenum() < 1200116;}
if(Name() == "SUVENPHAR.EQ-NSE"){includeok = Datenum() >=1200925;}
if(Name() == "SUZLON.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "SWANENERGY.EQ-NSE"){includeok = (Datenum() >=1130401 AND Datenum() < 1210930) OR (Datenum()>=1220930);}
if(Name() == "SWARAJENG.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1160401) OR (Datenum()>=1200925 AND Datenum() < 1210331);}
if(Name() == "SYMPHONY.EQ-NSE"){includeok = Datenum() >=1150928;}
if(Name() == "SYNDIBANK.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1191227;}
if(Name() == "SYNGENE.EQ-NSE"){includeok = Datenum() >=1160401;}
if(Name() == "TAJGVK.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1120928;}
if(Name() == "TAKE.EQ-NSE"){includeok = Datenum() >=1160401 AND Datenum() < 1200925;}
if(Name() == "TNPL.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1190927;}
if(Name() == "TNPETRO.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1111010;}
if(Name() == "TANLA.EQ-NSE"){includeok = Datenum() >=1210331;}
if(Name() == "TASTYBITE.EQ-NSE"){includeok = Datenum() >=1191227 AND Datenum() < 1220331;}
if(Name() == "TATACHEM.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1191227) OR (Datenum()>=1200925);}
if(Name() == "TATACOFFEE.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1190927) OR (Datenum()>=1200925);}
if(Name() == "TATACOMM.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1180629) OR (Datenum()>=1200626);}
if(Name() == "TCS.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "TATAELXSI.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "TATACONSUM.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "TATAINVEST.EQ-NSE"){includeok = (Datenum() >=1090202 and Datenum() < 1160401) OR (Datenum()>=1170331 AND Datenum() < 1210930) OR (Datenum()>=1220331);}
if(Name() == "TATAMETALI.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1120427;}
if(Name() == "TATAMTRDVR.EQ-NSE"){includeok = Datenum() >=1160401;}
if(Name() == "TATAMOTORS.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "TATAPOWER.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "TATASTLLP.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1190329) OR (Datenum()>=1210930 AND Datenum() < 1220930);}
if(Name() == "TATASTEEL.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "TTML.EQ-NSE"){includeok = (Datenum() >=1160401 AND Datenum() < 1160930) OR (Datenum()>=1210930);}
if(Name() == "TCIEXP.EQ-NSE"){includeok = Datenum() >=1190927;}
if(Name() == "TCNSBRANDS.EQ-NSE"){includeok = Datenum() >=1190329;}
if(Name() == "TDPOWERSYS.EQ-NSE"){includeok = Datenum() >=1120427 AND Datenum() < 1160401;}
if(Name() == "TEAMLEASE.EQ-NSE"){includeok = Datenum() >=1180928;}
if(Name() == "TECHM.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "TECHNOE.EQ-NSE"){includeok = (Datenum() >=1120427 AND Datenum() < 1180808) OR (Datenum()>=1190927 AND Datenum() < 1200626);}
if(Name() == "TV_18.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1110621;}
if(Name() == "TEXRAIL.EQ-NSE"){includeok = Datenum() >=1160401 AND Datenum() < 1190329;}
if(Name() == "NIACL.EQ-NSE"){includeok = Datenum() >=1180928;}
if(Name() == "RAMCOCEM.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "THERMAX.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "THIRUSUGAR.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1090327;}
if(Name() == "THOMASCOOK.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1190927;}
if(Name() == "THYROCARE.EQ-NSE"){includeok = Datenum() >=1170331;}
if(Name() == "CHOLAHLDNG.EQ-NSE"){includeok = Datenum() >=1180205;}
if(Name() == "TIDEWATER.EQ-NSE"){includeok = Datenum() >=1160401 AND Datenum() < 1170929;}
if(Name() == "TI.EQ-NSE"){includeok = Datenum() >=1141128 AND Datenum() < 1150327;}
if(Name() == "TIMETECHNO.EQ-NSE"){includeok = Datenum() >=1170929 AND Datenum() < 1200925;}
if(Name() == "TIMKEN.EQ-NSE"){includeok = Datenum() >=1160401;}
if(Name() == "TINPLATE.EQ-NSE"){includeok = Datenum() >=1100708 AND Datenum() < 1140919;}
if(Name() == "TITAN.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "TORNTPHARM.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "TORNTPOWER.EQ-NSE"){includeok = Datenum() >=1090731;}
if(Name() == "TFCILTD.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1111010;}
if(Name() == "TCI.EQ-NSE"){includeok = (Datenum() >=1160401 AND Datenum() < 1160429) OR (Datenum()>=1220930);}
if(Name() == "TREEHOUSE.EQ-NSE"){includeok = Datenum() >=1120427 AND Datenum() < 1160930;}
if(Name() == "TRENT.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "TBZ.EQ-NSE"){includeok = Datenum() >=1130401 AND Datenum() < 1160930;}
if(Name() == "TRIDENT.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1111010) OR (Datenum()>=1140328);}
if(Name() == "TRIVENI.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1110503) OR (Datenum()>=1220531);}
if(Name() == "TRITURBINE.EQ-NSE"){includeok = (Datenum() >=1160401 and Datenum() < 1170929) OR (Datenum()>=1190329 AND Datenum() < 1190927) OR (Datenum()>=1191227 AND Datenum()< 1200626) OR (Datenum()>=1210331);}
if(Name() == "TTKPRESTIG.EQ-NSE"){includeok = Datenum() >=1120928;}
if(Name() == "TIINDIA.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1170526) OR (Datenum()>=1180629);}
if(Name() == "TULIP.EQ-NSE"){includeok = Datenum() >=1090619 AND Datenum() < 1140328;}
if(Name() == "TVTODAY.EQ-NSE"){includeok = (Datenum() >=1090202 and Datenum() < 1120928) OR (Datenum()>=1140919 AND Datenum() < 1160401) OR (Datenum()>=1160429 AND Datenum()< 1210331);}
if(Name() == "TV18BRDCST.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "TVSMOTOR.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "TVSSRICHAK.EQ-NSE"){includeok = Datenum() >=1160401 AND Datenum() < 1190329;}
if(Name() == "UCALFUEL.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1091022;}
if(Name() == "UCOBANK.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1220930) OR (Datenum()>=1221230);}
if(Name() == "UFLEX.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "UJJIVAN.EQ-NSE"){includeok = Datenum() >=1170123 AND Datenum() < 1220331;}
if(Name() == "UJJIVANSFB.EQ-NSE"){includeok = Datenum() >=1200626 AND Datenum() < 1220331;}
if(Name() == "ULTRACEMCO.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "UNICHEMLAB.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1190329;}
if(Name() == "UNIONBANK.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "UNITECH.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1180928;}
if(Name() == "UNITEDBNK.EQ-NSE"){includeok = Datenum() >=1170929 AND Datenum() < 1180402;}
if(Name() == "UBHOLDINGS.EQ-NSE"){includeok = Datenum() >=1120409 AND Datenum() < 1140328;}
if(Name() == "UBL.EQ-NSE"){includeok = Datenum() >=1091022;}
if(Name() == "MCDOWELL_N.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1140919) OR (Datenum()>=1150327);}
if(Name() == "UNITY.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1130401;}
if(Name() == "UPL.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "USHAMART.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1160401;}
if(Name() == "UTIAMC.EQ-NSE"){includeok = Datenum() >=1210331;}
if(Name() == "UTTAMSTL.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1160401;}
if(Name() == "UTTAMSUGAR.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1091022;}
if(Name() == "UTVSOF.EQ-NSE"){includeok = Datenum() >=1090327 AND Datenum() < 1120309;}
if(Name() == "VIPIND.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "V2RETAIL.EQ-NSE"){includeok = Datenum() >=1090327 AND Datenum() < 1110325;}
if(Name() == "WABAG.EQ-NSE"){includeok = Datenum() >=1140919 AND Datenum() < 1200626;}
if(Name() == "VAIBHAVGBL.EQ-NSE"){includeok = (Datenum() >=1140328 AND Datenum() < 1160930) OR (Datenum()>=1190924);}
if(Name() == "VAKRANGEE.EQ-NSE"){includeok = Datenum() >=1120928 AND Datenum() < 1220930;}
if(Name() == "VALIANTORG.EQ-NSE"){includeok = Datenum() >=1210331 AND Datenum() < 1220331;}
if(Name() == "VALUEIND.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1091022;}
if(Name() == "VTL.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1110325) OR (Datenum()>=1130927);}
if(Name() == "VARROC.EQ-NSE"){includeok = Datenum() >=1181228;}
if(Name() == "VBL.EQ-NSE"){includeok = Datenum() >=1170526;}
if(Name() == "VARUNSHIP.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1130927;}
if(Name() == "VENKEYS.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1150327) OR (Datenum()>=1180928 AND Datenum() < 1220930);}
if(Name() == "VESUVIUS.EQ-NSE"){includeok = (Datenum() >=1090202 and Datenum() < 1160401) OR (Datenum()>=1170929 AND Datenum() < 1180402) OR (Datenum()>=1200626 AND Datenum()< 1200925);}
if(Name() == "VGUARD.EQ-NSE"){includeok = Datenum() >=1160401;}
if(Name() == "VIDEOIND.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1180313;}
if(Name() == "VIJAYABANK.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1190128;}
if(Name() == "VINATIORGA.EQ-NSE"){includeok = Datenum() >=1150327;}
if(Name() == "VINDHYATEL.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1090327;}
if(Name() == "VIVIDHA.EQ-NSE"){includeok = Datenum() >=1150529 AND Datenum() < 1160401;}
if(Name() == "VISHALEXPO.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1090327;}
if(Name() == "VMART.EQ-NSE"){includeok = Datenum() >=1180928;}
if(Name() == "VOLTAS.EQ-NSE"){includeok = Datenum() >=1090202;}
if(Name() == "VRLLOG.EQ-NSE"){includeok = Datenum() >=1150928 AND Datenum() < 1210331;}
if(Name() == "VSTIND.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1170929) OR (Datenum()>=1190329 AND Datenum() < 1210930);}
if(Name() == "WABCOINDIA.EQ-NSE"){includeok = Datenum() >=1120427 AND Datenum() < 1220303;}
if(Name() == "WELCORP.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1131118) OR (Datenum()>=1140919);}
if(Name() == "WELSPUNIND.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1090619) OR (Datenum()>=1130401);}
if(Name() == "WSTCSTPAPR.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1140919;}
if(Name() == "WESTLIFE.EQ-NSE"){includeok = Datenum() >=1191227;}
if(Name() == "WHEELS.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1090327) OR (Datenum()>=1140919 AND Datenum() < 1160401);}
if(Name() == "WHIRLPOOL.EQ-NSE"){includeok = Datenum() >=1110325;}
if(Name() == "WIPRO.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1130401) OR (Datenum()>=1130807);}
if(Name() == "WOCKPHARMA.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1120427) OR (Datenum()>=1130401);}
if(Name() == "WONDERLA.EQ-NSE"){includeok = Datenum() >=1160401 AND Datenum() < 1170929;}
if(Name() == "WYETH.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1140512;}
if(Name() == "YESBANK.EQ-NSE"){includeok = (Datenum() >=1091022 AND Datenum() < 1200319) OR (Datenum()>=1200925);}
if(Name() == "ZANDUREALT.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1091222;}
if(Name() == "ZEEL.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1101007) OR (Datenum()>=1110325);}
if(Name() == "ZEELEARN.EQ-NSE"){includeok = Datenum() >=1160401 AND Datenum() < 1180928;}
if(Name() == "ZEEMEDIA.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1100415;}
if(Name() == "ZENSARTECH.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1180402) OR (Datenum()>=1180928);}
if(Name() == "ZODIACLOTH.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1140328;}
if(Name() == "ZUARIGLOB.EQ-NSE"){includeok = Datenum() >=1090202 AND Datenum() < 1120409;}
if(Name() == "ZYDUSWELL.EQ-NSE"){includeok = (Datenum() >=1110325 AND Datenum() < 1170929) OR (Datenum()>=1180928);}
if(Name() == "BURGERKING.EQ-NSE"){includeok = Datenum() >=1210429 AND Datenum() < 1220216;}
if(Name() == "GLAND.EQ-NSE"){includeok = Datenum() >=1210630;}
if(Name() == "RHIM.EQ-NSE"){includeok = Datenum() >=1210720;}
if(Name() == "POONAWALLA.EQ-NSE"){includeok = Datenum() >=1210930;}
if(Name() == "ANURAS.EQ-NSE"){includeok = Datenum() >=1210930;}
if(Name() == "HGS.EQ-NSE"){includeok = Datenum() >=1210930;}
if(Name() == "EQUITASBNK.EQ-NSE"){includeok = Datenum() >=1210930;}
if(Name() == "FACT.EQ-NSE"){includeok = Datenum() >=1210930;}
if(Name() == "HOMEFIRST.EQ-NSE"){includeok = Datenum() >=1210930;}
if(Name() == "IRFC.EQ-NSE"){includeok = Datenum() >=1210930;}
if(Name() == "INDIGOPNTS.EQ-NSE"){includeok = Datenum() >=1210930;}
if(Name() == "JUBLINGREA.EQ-NSE"){includeok = Datenum() >=1210930;}
if(Name() == "KALYANKJIL.EQ-NSE"){includeok = Datenum() >=1210930;}
if(Name() == "LXCHEM.EQ-NSE"){includeok = Datenum() >=1210930;}
if(Name() == "LODHA.EQ-NSE"){includeok = Datenum() >=1210930;}
if(Name() == "NAZARA.EQ-NSE"){includeok = Datenum() >=1210930;}
if(Name() == "RAILTEL.EQ-NSE"){includeok = Datenum() >=1210930;}
if(Name() == "RAILTEL.EQ-NSE"){includeok = Datenum() >=1211028 AND Datenum() < 1220930;}
if(Name() == "ANGELONE.EQ-NSE"){includeok = Datenum() >=1211110;}
if(Name() == "PCBL.EQ-NSE"){includeok = Datenum() >=1220112;}
if(Name() == "RBA.EQ-NSE"){includeok = Datenum() >=1220216;}
if(Name() == "ZFCVINDIA.EQ-NSE"){includeok = Datenum() >=1220303;}
if(Name() == "ZYDUSLIFE.EQ-NSE"){includeok = Datenum() >=1220304;}
if(Name() == "ABSLAMC.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "ALLCARGO.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1201102) OR (Datenum()>=1220331 AND Datenum() < 1221230);}
if(Name() == "APTUS.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "BORORENEW.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "BCG.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "MAPMYINDIA.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "CHEMPLAST.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1120618) OR (Datenum()>=1220331);}
if(Name() == "CLEAN.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "DEVYANI.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "EASEMYTRIP.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "NYKAA.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "GRINFRA.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "GLS.EQ-NSE"){includeok = Datenum() >=1220331 AND Datenum() < 1220930;}
if(Name() == "GOCOLORS.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "HLEGLAS.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "KIMS.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "LATENTVIEW.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "MEDPLUS.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "METROBRAND.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "NUVOCO.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "PAYTM.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "POLICYBZR.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "PRIVISCL.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "RTNINDIA.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "SAPPHIRE.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "RENUKA.EQ-NSE"){includeok = (Datenum() >=1090202 AND Datenum() < 1200925) OR (Datenum()>=1220331);}
if(Name() == "SHYAMMETL.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "STARHEALTH.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "TATAINVEST.EQ-NSE"){includeok = (Datenum() >=1090202 and Datenum() < 1160401) OR (Datenum()>=1170331 AND Datenum() < 1210930) OR (Datenum()>=1220331);}
if(Name() == "VIJAYA.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "ZOMATO.EQ-NSE"){includeok = Datenum() >=1220331;}
if(Name() == "MTARTECH.EQ-NSE"){includeok = Datenum() >=1220407;}
if(Name() == "CGCL.EQ-NSE"){includeok = (Datenum() >=1190927 AND Datenum() < 1220331) OR (Datenum()>=1220412);}
if(Name() == "UNOMINDA.EQ-NSE"){includeok = Datenum() >=1220804;}
if(Name() == "CAMPUS.EQ-NSE"){includeok = Datenum() >=1220808;}
if(Name() == "DELHIVERY.EQ-NSE"){includeok = Datenum() >=1220808;}
if(Name() == "LICI.EQ-NSE"){includeok = Datenum() >=1220808;}
if(Name() == "AWL.EQ-NSE"){includeok = Datenum() >=1220930;}
if(Name() == "AETHER.EQ-NSE"){includeok = Datenum() >=1220930;}
if(Name() == "GREENPANEL.EQ-NSE"){includeok = Datenum() >=1220930;}
if(Name() == "JBMA.EQ-NSE"){includeok = Datenum() >=1220930;}
if(Name() == "MSUMI.EQ-NSE"){includeok = Datenum() >=1220930;}
if(Name() == "PATANJALI.EQ-NSE"){includeok = Datenum() >=1220930;}
if(Name() == "TEJASNET.EQ-NSE"){includeok = Datenum() >=1220930;}
if(Name() == "MANYAVAR.EQ-NSE"){includeok = Datenum() >=1220930;}
if(Name() == "OLECTRA.EQ-NSE"){includeok = Datenum() >=1220930;}
