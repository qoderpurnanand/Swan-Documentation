# -*- coding: utf-8 -*-
"""
Created on Wed Jan 18 14:00:51 2023
...
if os.path.exists(r"C:\Users\admin\Desktop\Pyspark\Half_Yearly\\Banknifty-I.csv"):
    os.remove(r"C:\Users\admin\Desktop\Pyspark\Half_Yearly\\Banknifty-I.csv")
    
if os.path.exists(r"C:\Users\admin\Desktop\Pyspark\Half_Yearly\\Banknifty-II.csv"):
    os.remove(r"C:\Users\admin\Desktop\Pyspark\Half_Yearly\\Banknifty-II.csv")
...
if final_df.empty==False:    
    ...
    test.to_csv(r"C:\Users\admin\Desktop\Pyspark\Half_Yearly\\Banknifty-I.csv",index=False)
...
if final_df.empty==False:
    ...
    test.to_csv(r"C:\Users\admin\Desktop\Pyspark\Half_Yearly\\Banknifty-II.csv",index=False)
